...
export function Testimonials({
  ...
  const TestimonialCard = ({ item }: { item: SectionItem }) => {
    return (
      <div className="bg-card/25 ring-foreground/[0.07] flex flex-col justify-end gap-6 rounded-[var(--radius)] border border-transparent p-8 ring-1">
    ...
    >
      <div className="container">
        ...
        <ScrollAnimation delay={0.2}>
          <div className="border-border/50 relative rounded-[var(--radius)]">

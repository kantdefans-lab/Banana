...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'wavespeed',
      title: 'WaveSpeed',
      description: `Custom <a href="https://wavespeed.ai" class="text-primary" target="_blank">WaveSpeed</a> settings`,
      tab: 'ai',
    },
    {
      name: 'kie',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      placeholder: 'ws_xxx',
      group: 'wavespeed',
      tip: 'WaveSpeed API Key is used to access the WaveSpeed API',
      tab: 'ai',
    },
    {
      name: 'kie_api_key',

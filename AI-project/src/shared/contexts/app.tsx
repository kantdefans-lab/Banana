...
// 修复部分开始：提供安全的默认值，防止 "is not a function" 错误
const AppContext = createContext({
  user: null,
  isCheckSign: false,
  isShowSignModal: false,
  setIsShowSignModal: () => {}, // 空函数默认值
  isShowPaymentModal: false,
  setIsShowPaymentModal: () => {}, // 空函数默认值
  configs: {},
  fetchUserCredits: async () => {}, // 异步空函数默认值
  fetchUserInfo: async () => {}, // 异步空函数默认值
} as ContextValue);
// 修复部分结束

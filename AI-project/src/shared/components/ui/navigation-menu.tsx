...
function NavigationMenuViewport({
  ...
  return (
    <div
      className={cn(
        "px-[var(--viewport-outer-px)] fixed inset-x-0 top-12 isolate z-50 mx-auto flex max-w-6xl"
      )}
    >
      <NavigationMenuPrimitive.Viewport
        data-slot="navigation-menu-viewport"
        className={cn(
          "bg-popover text-popover-foreground h-[var(--radix-navigation-menu-viewport-height)] ring-foreground/10 rounded-[var(--radius)] md:w-[var(--radix-navigation-menu-viewport-width)] relative mt-1.5 w-full origin-top overflow-hidden border border-transparent p-0.5 shadow-xl shadow-black/10 ring-1 transition-[width,height] duration-200",
